...
export default function selectedProjectId({project,onDelete,onAddNewTasks,onDeleteNewTasks,showTask}){
    ...
    return (
        <div className="w-[53rem] mt-16">
            ...
            <Tasks onAdd={onAddNewTasks} onDelete={onDeleteNewTasks} tasks={showTask}></Tasks>
        </div>
    );
